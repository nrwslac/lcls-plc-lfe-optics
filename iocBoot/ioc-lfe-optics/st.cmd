...
#
#         Project: lcls-plc-lfe-optics.tsproj
#        PLC name: lfe_optics (lfe_optics Instance)
# Generated using: pytmc 2.18.2
# Project version: v1.1.1-77-gfb29126
#    Project hash: fb29126e074aa0f91b32dbb5a9c64001c7c06b1d
#     PLC IP/host: 172.21.88.30
#      PLC Net ID: 172.21.88.30.1.1
#  ** Production mode IOC **
...
epicsEnvSet("ADS_MAX_PARAMS",   "5599")
...
system("${ADS_IOC_TOP}/scripts/add_route.sh 172.21.88.30 ^172.*")
...
epicsEnvSet("MOTOR_PREFIX",    "SP1L0:DCCM:MMS:")
epicsEnvSet("MOTOR_NAME",      "TH1")
epicsEnvSet("DESC",            "Main.M13 / SP1L0-TH1")
...
epicsEnvSet("DESC",            "Main.M14 / SP1L0-TH2")
epicsEnvSet("EGU",             "Degree")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("DESC",            "Main.M15 / SP1L0-Tx")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("DESC",            "Main.M16 / SP1L0-Txd")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("DESC",            "Main.M17 / SP1L0-Tyd")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=$(ASYN_PORT),PREFIX=PLC:LFE:OPTICS,IDX=1,TASK_PORT=352")
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=$(ASYN_PORT),PREFIX=PLC:LFE:OPTICS,IDX=2,TASK_PORT=351")
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=$(ASYN_PORT),PREFIX=PLC:LFE:OPTICS,IDX=3,TASK_PORT=350")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=$(ASYN_PORT), PREFIX=PLC:LFE:OPTICS")

dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:LFE:OPTICS,PROJECT=lcls-plc-lfe-optics.tsproj,HASH=fb29126,VERSION=v1.1.1-77-gfb29126,PYTMC=2.18.2,PLC_HOST=172.21.88.30")

#   LCLS General: * -> 2.8.2 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=LCLS_General,VERSION=2.8.2,VENDOR=SLAC")
#   lcls2-cc-lib: * -> 2.0.0 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=lcls2-cc-lib,VERSION=2.0.0,VENDOR=SLAC")
#   Tc2_ControllerToolbox: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=Tc2_ControllerToolbox,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc2_MC2: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=Tc2_MC2,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc2_SerialCom: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=Tc2_SerialCom,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc2_Standard: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=Tc2_Standard,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc2_System: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=Tc2_System,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc2_Utilities: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=Tc2_Utilities,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc3_Module: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=Tc3_Module,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   VisuDialogs: * (System)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=VisuDialogs,VERSION=*,VENDOR=System")
#   VisuElemMeter: 3.5.10.0 (System)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=VisuElemMeter,VERSION=3.5.10.0,VENDOR=System")
#   VisuElems: 3.5.10.40 (System)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=VisuElems,VERSION=3.5.10.40,VENDOR=System")
#   VisuElemsSpecialControls: 3.5.10.0 (System)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=VisuElemsSpecialControls,VERSION=3.5.10.0,VENDOR=System")
#   VisuElemsWinControls: 3.5.10.40 (System)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=VisuElemsWinControls,VERSION=3.5.10.40,VENDOR=System")
#   VisuElemTextEditor: 3.5.10.10 (System)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=VisuElemTextEditor,VERSION=3.5.10.10,VENDOR=System")
#   visuinputs: 3.5.10.0 (system)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=visuinputs,VERSION=3.5.10.0,VENDOR=system")
#   VisuNativeControl: 3.5.10.40 (System)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:OPTICS,DEPENDENCY=VisuNativeControl,VERSION=3.5.10.40,VENDOR=System")

cd "$(IOC_TOP)"

## PLC Project Database files ##
dbLoadRecords("lfe_optics.db", "PORT=$(ASYN_PORT),PREFIX=PLC:LFE:OPTICS:,IOCNAME=$(IOC),IOC=$(IOC)")

# Total records: 4599
callbackSetQueueSize(11198)
